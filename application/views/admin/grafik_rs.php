...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo site_url(); ?>data_umum/jquery.min.js"></script>
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var options = {
                    ...
                    title: {
                        text: 'Statistika Pasien Rumah Sakit ',
                        x: -20 //center
                    },
                    subtitle: {
                        text: '',
                ...
                function getAjaxData(id) {
                    $.getJSON("<?php echo site_url(); ?>admin/data_grafik_rs", {id: id}, function(json) {
