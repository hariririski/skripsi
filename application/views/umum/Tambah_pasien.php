    ...
    <div class="container">
      ...
      <div class="card card-outline-success mb-3">
            ...
            <div class="card-block">
              <form method="POST" action="<?php echo site_url(); ?>pasien/tambah">
                    <div class="form-group row">
                      <label for="example-text-input" class="col-3 col-form-label">NIK</label>
                      <div class="col-9">
                          <input class="form-control" autofocus="on" readonly value="<?php echo $this->uri->segment('3')?>" required type="text" name="nik" id="example-text-input" placeholder="Masukkan Nama Ruang">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="example-text-input" class="col-3 col-form-label">Nama</label>
                      <div class="col-9">
                          <input class="form-control" autofocus="on"   required type="text" name="nama_pasien" id="example-text-input" placeholder="Masukkan Nama">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="example-text-input" class="col-3 col-form-label">jenis_kelamin</label>
                      <div class="col-9">
                        <select  class="form-control select2-hidden-accessible" name="id_jenis_kelamin" data-plugin="select2" data-placeholder="Pilih Kabupaten" data-allow-clear="true" tabindex="-1" aria-hidden="true">
                          ...
                          <?php
                             ...
                             $i++;
                           ?>
                          <option value="<?php echo $jenis_kelamin->id_jenis_kelamin; ?>"><?php echo $jenis_kelamin->nama_jenis_kelamin; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <select id="kamar" class="form-control select2-hidden-accessible" name="kamar" data-plugin="select2" data-placeholder="Pilih Kecamatan" data-allow-clear="true" tabindex="-1" aria-hidden="true">
                          <option value="">Pilih</option>
                        </select>
                      </div>
                    </div>
