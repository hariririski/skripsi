    ...
    <div class="container">
      ...
      <div class="card card-outline-success mb-3">
            ...
            <div class="card-block">
              <form method="POST" action="<?php echo site_url(); ?>ruang/tambah">
                    ...
                    <?php
                     ...
                     ?>
                      <tr>
                          ...
                          <td class="center"><a href="<?php echo site_url(); ?>kamar/kamar/<?php echo $data_ruang->id_ruang ?>"><button type="button" class="btn btn-success btn-xs">Detail</button></td>
                            <td class="center"><a href="<?php echo site_url(); ?>ruang/edit_ruang?id=<?php echo $data_ruang->id_ruang?>" onclick="return confirm('Apakah Anda Yakin Meemperbaharui ?')" ><button type="button" class="btn btn-warning btn-xs">Edit</button></td>
                            <td class="center"><a href="<?php echo site_url(); ?>ruang/hapus_ruang?id=<?php echo $data_ruang->id_ruang?>" onclick="return confirm('Apakah Anda Yakin Menghapus ?')" ><button type="button" class="btn btn-danger btn-xs">Hapus</button></td>
                          </tr>
                      <?php
                      }
                     ?>
