                ...
                <div class="form-group row">
                  ...
                  <div class="col-9">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                          <input class="form-control" required type="text" name="nama_ruang" id="example-text-input" required placeholder="Masukkan Nama Kamar">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="example-text-input" class="col-3 col-form-label">Jumlah Tempat Tidur</label>
                      <div class="col-9">
                        <input class="form-control" required type="number" name="nama_ruang" id="example-text-input" required placeholder="Masukkan Jumlah Tempat">
                  ...
                  <tbody>
                    ...
                    <?php
                     ...
                     ?>
                      <tr>
                          <td><?php echo $i?></td>
                          <td><?php echo $data_kamar->nama_ruang ?></td>
