              ...
              <div class="form-group row">
                  ...
                  <div class="col-9">
                      <div class="form-group row col-12">
                        ...
                        <div class="col-9">
                          <input class="form-control" readonly type="text" value="<?php echo $profil->kode_rs?>"  required name="kode_rs" placeholder="Kode Rumah Sakit">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label for="example-text-input" class="col-3 col-form-label">Nama Rumah Sakit</label>
                        <div class="col-9">
                          <input class="form-control"  type="text" value="<?php echo $profil->nama_rs?>"  required name="nama_rs" placeholder="Kode Rumah Sakit">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label for="example-text-input" class="col-3 col-form-label">Alamat</label>
                        <div class="col-9">
                          <input class="form-control" type="text" value="<?php echo $profil->alamat?>"  required name="alamat" placeholder="alamat">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label for="example-text-input" class="col-3 col-form-label">No_Hp</label>
                        <div class="col-9">
                          <input class="form-control"  type="text" value="<?php echo $profil->no_hp?>"  required name="no_hp" placeholder="NO Hp Yang Akan Dihubungi">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label for="example-text-input" class="col-3 col-form-label">Email</label>
                        <div class="col-9">
                          <input class="form-control"  type="text" value="<?php echo $profil->email?>"  required name="email" placeholder="Email">
                        </div>
                      </div>
                      <div class="form-group row col-12">
